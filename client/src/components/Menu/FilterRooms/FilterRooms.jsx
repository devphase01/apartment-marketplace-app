  ...
  const handleFilter = (event, element) => {
    ...
    filterElements.forEach((filterElement) => {
      if (filterElement.dataset.name !== dataValue) filterElement.classList.remove('active');
        ...
        setFilterByRooms(filterElement.classList.contains('active')
          ? element.textContent
          : null);
      }
    });
          ...
          <div className="filter-rooms__menu">
            ...
            <div className="filter-rooms__items">
              <div
                ...
                data-name="1"
                onClick={(e) => handleFilter(e, e.target)}>1</div>
              <div
                className="filter-rooms__item"
                data-name="2"
                onClick={(e) => handleFilter(e, e.target)}>2</div>
              <div
                className="filter-rooms__item"
                data-name="3"
                onClick={(e) => handleFilter(e, e.target)}>3</div>
              <div
                className="filter-rooms__item"
                data-name="4+"
                onClick={(e) => handleFilter(e, e.target)}>4+</div>
            </div>
